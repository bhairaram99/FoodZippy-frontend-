...
const testimonials: Testimonial[] = [
  ...
  {
    quote: 'Late night study sessions are so much better now with quick and affordable food delivery. Foodzippy understands student life!',
    name: 'Priya Sharma',
    role: 'Engineering Student',
    initials: 'PS'
  },
  {
    quote: 'Finally a food delivery service that does not burn a hole in my pocket. The quality is excellent and delivery is super fast.',
    name: 'Arjun Singh',
    ...
    <section className="py-16 sm:py-24 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl shadow-xl p-8 sm:p-12 md:p-16">
